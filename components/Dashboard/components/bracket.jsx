...
function Basket() {
  ...
  return (
    <Link href="/dashboard/checkout">
      <div className="fixed lg:bottom-18 lg:top-32 lg:flex hidden   right-10 z-50 flex h-16 w-24 cursor-pointer items-center justify-center rounded-full bg-gray-300">
        {items.length > 0 && (
